            					...
            					<div class="body">
            						...
            						<div class="row clearfix">
            							...
            							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text" value="" class="form-control" placeholder="Ex : Nama " name="nama" required autocomplete="off" />
            									</div>
            								</div>
            							</div>
            						</div>
            						...
            						<div class="row clearfix">
            							...
            							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text" value="" class="form-control" placeholder="Ex: blablacrocxxx" name="username" required autocomplete="off" <?= isset($user['username']) ? 'readonly' : ''; ?> />
