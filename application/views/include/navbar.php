    ...
    <nav class="navbar">
    	<div class="container-fluid">
    		<div class="navbar-header">
    			...
    			<a class="navbar-brand" href="index.html">Admin Universitas</a>
    		</div>
    ...
    <section>
    	...
    	<aside id="leftsidebar" class="sidebar">
    			...
    			<ul class="list">
    				...
    				<li class="">
    					...
    					<ul class="ml-menu">
    						...
    						<li class="#">
    							<a href="<?= base_url(); ?>siswa/laporan">Laporan Siswa</a>
    						</li>
    					</ul>
    				</li>
    				<li class="">
    		...
    		<div class="legal">
    			<div class="copyright">
    				&copy; 2020 <a href="javascript:void(0);">Created By Wahid & Frandika</a>.
    			</div>
    			<div class="version">
    				<b>Version: </b> 1.0
    			</div>
